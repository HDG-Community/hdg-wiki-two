...
draft: false
description: The HDG Worlds and Locations hub.
Params:
  icon: world
weight: 40
---
# Worlds, Ships, and Locations
...
As such, the Guide can never host a truly complete catalog of all known worlds — but we can try! 

## Community Location Glossary
> [!LORET]
> This section will serve as a hub to feature various ships, planets, and other locations from a wide variety of stories throughout the setting. as this page is a **Work In Progress,** we have added two examples below to showcase their formatting. We can't wait to add more!
### Hablis-9
...
{{< image worlds_and_locations_sheepwave "A painting of a landscape being surveyed by an affini and floret." inline >}}
