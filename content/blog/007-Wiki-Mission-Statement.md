...
draft: false
description: An update on the HDG wiki status and Mission.
Params:
  decoration: meta
---
You might have noticed some big things happening here on [HDG.wiki](https://hdg.wiki/)! Let's talk about that.
...
The one we all write in, together.
