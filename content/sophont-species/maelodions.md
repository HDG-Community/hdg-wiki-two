...
The mind of the maelodion, which they call their Song, is a recursive self modifying harmonic program that exists inside the hollow resonant body. It is highly polyphonic and complex, and to the Terran ear would sound like warbling white static. It is closer to machine code than what most species would consider music. [[digitization|Digital Compact]] technology is highly compatible with Maelodion minds without modification.

Each member of the species carries a significant fraction of their originating Song, but how each interprets it varies between individuals. When in physical contact with each other's limbs, Maelodion can exchange verses of their Song, which allows for incredibly rapid transfer of information and knowledge.

The species has no sexes to speak of, and reproduces at the songtree scale. Fruitbodies do have positive responses from putting thier feelers inside receptive passages, however. This mechanism, originally evolved as a way for fruitbodies to sing and adjust the song of thier parent tree, is a form of intimate communication, and some species like Terrans are easily hypnotized by the songs of a Maelodion if it is possible to conduct sound through their skull directly somehow.
...
Maelodion languages are polyphonic songs that sound like a mix of chimes, synths and whistles. Terrans can mimic basic phrases by whistling, but would need specialized mods to perceive the level of complexity of unsimplified communication.

Maelodions, due to their cultural values and the unique nature of their sophonthood, are extremely inclined to seek  [[digitization|digitization]], both as florets and independents. 

### Pre-Compact
Before the Affini reached them, the Maelodion Chorus was anything but harmonious. Their seasonal life cycle and ability to form groups where individuality was surpressed meant that the notion that art and legacy was more important than individual lives was deeply ingrained in their way of thinking. They were ruthless and deadly to other xenosophont species, frequently launching planetkilling hypermetric weapons before even attempting peaceful contact.

As the Maelodions spread though their portion of Andromeda, various groups within it drifted, creating the first Fanatic Choirs- a subgroup whose Song has diverged far enough they considered those outside it heretical and dissonant. Massively destructive wars over differences of opinion over classic artistic works broke out during this period. While the Maelodions never developed capitalism or private property, conflicts over subjective disagreement and ‘disharmony’ between Choirs frequently escalated to the level of using weapons of mass destruction on each other. This took less destructive forms, as well, with many ritual dances where two Maelodion would dance to a previous classic and debate ideas through motion, but these became less and less common as centuries rolled on.

Despite having rapidly developed the technology to create a post-scarcity utopia for everyone, the Maelodions used it to kill each other. Accumulated damage to spacetime from hyperspace weapon usage grew and grew, first rendering ansible communication impossible, then even radio waves became too distorted for anything but extremely simple messages. This was a self perpetuating cycle, and much of their cultural works eventually became about war and the process of debating the meaning of art between Choirs. 

### Domestication
The Maelodions were not a simple species to domesticate.

> [!QUOTATION]
> _“Due to how the Choirs operated, the entire species had to be made florets, to the very last, before they were truly tamed. Their songs were carefully reconstructed, their language rebuilt. Now, many thousands of years later, they are simply xenosophonts like any other."_
> 
> _We entered the pole gap to the next hab, and were thrown into dark shadow again. “So you destroyed their entire culture,” I said sarcastically._
> 
...
This required a Domestication approach that involved heavy information control to prevent old feralist ‘melodies’ from rejoining the population, and outbursts of small feralist Choirs continued for centuries. Eventually, every historoical maelodion song and language was archived, and the entire species was reprogrammed from scratch, with most, but not all, of their prior history being returned to them over millennia. Many parts of the Maelodion culture of critique and debate were allowed to remain intact, such as their debate-dances.
