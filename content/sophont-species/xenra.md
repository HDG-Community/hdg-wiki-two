...
They put out mind-altering pheromones that encourage complementary emotions in other species— for example, someone smelling a sad xenra would result in a surge of compassion. The effect varies, but it can be exacerbated by venom produced by their fangs, claws, and sharp stingers on structures similar to pedipalps alongside their muzzles.

They don't commonly share space with Terrans, primarily due to the smell; their native language originally used a pheromonal form of emotional indicators which effect human physiology quite differently. In some Xenrani cultures, gifting scented garments— and even directly scent marking individuals— is a sign of courting or claiming a mate. For those so inclined, there are aerosolized counteragents that some xenra wear to mitigate the pharmacological effects, but they still tend to carry a strong scent.
...
Historically, food played a major role in Xenrani socialization, with the hunters who provided food for the family being regarded with high respect and importance. Among the many species hunted by the Xenrani are elk-like stagryn, avian xenpala, and lopabbits, which are themselves prey for xenpala. In modern times, food continues to be important to xenrani, who enjoy sharing, adopting, and blending meals from new cultures. 

Both creation and destruction are fundamental to Xenrani culture, which places great emphasis on the act of creating with one’s own hands. To this end, many xenra find the instant gratification of using compilers to be distasteful. Metalworkers, jewelry smiths, cobblers, and book binders are just a few of the many, many artisan crafters one can find among any community of Xenrani.
...
During the Xenrani Domestication Campaign, xenoveterinarians aboard the *Cymbidium* observed groups of xenra self-sorting into tripartite hierarchies. Within these hierarchies, three distinct groups were observed: Dominant Type, Neutral Type, and Submissive Type (roughly translated to Terran as “Alpha”, “Beta”, and “Omega”), and that these groups maintained sorting even when independently formed hierarchies were introduced to one another. Furthermore, new xenra introduced to the collective would conform to the preexisting hierarchical system.
